...
import { FileUploadModal } from '@/components/course-files/FileUploadModal';
import { FilePreviewModal } from '@/components/course-files/FilePreviewModal';
import { VirtualizedFilesList } from '@/components/course-files/VirtualizedFilesList';
import { formatBytes, getFileIcon, getFileTypeColor } from '@/lib/file-utils';

const CourseFilesManagement: React.FC = () => {
  ...
  const uniqueFileTypes = useMemo(() => {
    return [...new Set(files.map(f => f.file_type).filter(Boolean))];
  }, [files]);
...
export default CourseFilesManagement;