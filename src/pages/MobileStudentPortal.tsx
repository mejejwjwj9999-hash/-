...
import MobileCoursesWithEnrollment from '@/components/mobile-portal/MobileCoursesWithEnrollment';
import MobileCourseEnrollment from '@/components/mobile-portal/MobileCourseEnrollment';
...
import MobileAssignmentsEnhanced from '@/components/mobile-portal/MobileAssignmentsEnhanced';
...
const MobileStudentPortal = () => {
  ...
  useEffect(() => {
    ...
    if (tab && ['dashboard', 'courses', 'course-enrollment', 'assignments', 'schedule', 'financial', 'grades', 'documents', 'notifications', 'settings', 'student-services', 'service-requests', 'my-requests'].includes(tab)) {
      setActiveTab(tab);
    }
  }, []);
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'courses':
        return <MobileCoursesWithEnrollment />;
      case 'course-enrollment':
        return <MobileCourseEnrollment />;
      case 'assignments':
        return <MobileAssignmentsEnhanced />;
      case 'schedule':
